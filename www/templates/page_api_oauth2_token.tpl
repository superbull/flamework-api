...
<table class="api-key-or-token">
	...
	<tr>
		<td>Application</td><td><a href="{$cfg.abs_root_url}api/keys/{$token.app.api_key|escape}/">{$token.app.app_title|escape}</a> <span class="api-thisisyou"> ⇽ you made this</span></td>
	</tr>
	...
	<tr>
		<td>Access Token</td><td class="api-credential">{$token.access_token|escape}</td>
	</tr>
...
{/foreach}
	...
	<tr class="api-admin">
		<td>&nbsp;</td>
		<td class="api-delete"><input type="checkbox" name="delete" /> <label for="delete">Actually, I'd like to delete this auth token entirely</label></td>
	</tr>
